...
Run this on the live Bot Factory task.
...
4. Reply with that roster and the next factory action. Done when the reply names every bot and proposes at most one next action. Leave souls unchanged. Create no bots.
